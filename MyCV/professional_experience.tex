	...
	\textbf{Team lead \& Python Developer} \par {\emph ParsTech.Co}
        \begin{itemize}
          ...
          %\setlength{\itemindent}{-1em}
            \item Prototyped 4 services, including calibration, SFM, and orthomosaic generation, that were responsible for photogrammetric processing on drone images.
            \item Architected a photo aesthetic assessment service capable of visual RAG to analyse over 60 parameters using a specialized dataset. 
